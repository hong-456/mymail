<template>
    ...
    <!-- 传入两张图片，分别用于活跃和不活跃状态，使用v-show决定图片是否显示 -->
      <div v-show="!isShow"><slot name="img"><img src="../../assets/img/tagbar/home.png" alt=""></slot></div>
      <div v-show="isShow"><slot name="img2"><img src="../../assets/img/tagbar/home1.png" alt=""></slot></div>
